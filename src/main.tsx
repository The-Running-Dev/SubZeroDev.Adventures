...
// and `/u/<slug>` are the other paths it knows about: `/oauth/consent` is the authorization
// UI a configured Supabase project's OAuth 2.1 Server redirects to (OAuthConsent.tsx);
...
// submitted campaigns/extensions (src/content/MyContent.tsx); `/start` is the
// getting-started page and the campaign-authoring wizard (src/start/StartPage.tsx);
// `/u/<slug>` is a player's public profile (src/profile/PublicProfile.tsx). index.html's
// inline script restores the real pathname before this file runs, undoing the GitHub Pages
// 404 detour (public/404.html) for a direct navigation to any of them.
